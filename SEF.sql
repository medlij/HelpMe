...
(18, '2021_05_27_230529_create_clients_table', 2),
(19, '2021_05_27_230926_create_taskers_table', 2);
...
CREATE TABLE `taskers` (
  ...
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `category` set('fixing','cleaning','moving','other') COLLATE utf8mb4_unicode_ci NOT NULL,
  `location` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `avatar` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
ALTER TABLE `taskers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `taskers_email_unique` (`email`);

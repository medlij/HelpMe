...
CREATE TABLE `taskers` (
  ...
  `hourly_rate` int NOT NULL DEFAULT '50000',
...
CREATE TABLE `users` (
  ...
  `category` set('fixing','cleaning','moving','other') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
ALTER TABLE `taskers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `taskers_user_id_foreign` (`user_id`);
...
--
ALTER TABLE `taskers`
  ADD CONSTRAINT `taskers_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
COMMIT;
